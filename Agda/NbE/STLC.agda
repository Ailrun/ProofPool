...
-- Also, one cannot prove
--
--   ⟦ σ ⟧ ρ ↘ ω → ⟦ M ⟧ ω ↘ m → ⟦ [ σ ] M ⟧ ρ ↘ m
--
-- because of the closure case of ⟦_⟧_↘_
-- ⊨[_]_ :  Γ ⊨s σ ≋ σ' `: Δ →
--          Δ ⊨ M ≋ M' `: A →
--         ------------------------------
--          Γ ⊨ [ σ ] M ≋ [ σ' ] M' `: A
-- ⊨[_]_ {A = A} σ≋σ' M≋M' ρ ρ' ρ≣ρ'
--   with _ , _ , σ↘ , σ'↘ , ω≣ω' ← σ≋σ' _ _ ρ≣ρ'
--     with _ , _ , M↘ , M'↘ , m≣m' ← M≋M' _ _ ω≣ω'
--       with M↘ | M'↘
-- ...      | `!- | `!- = _ , _ , σ↘ _ , σ'↘ _ , m≣m'
-- ...      | `!- | `λ- = {!!}
-- ...      | `!- | x `$ x₁ & x₂ = {!!}
-- ...      | `!- | `zero = _ , `zero , σ↘ _ , `zero , m≣m'
-- ...      | `!- | `suc = _ , `suc , σ↘ _ , `suc , m≣m'
-- ...      | `!- | `rec = _ , `rec _ , σ↘ _ , `rec , m≣m'
-- ...      | `λ- | `!- = {!!}
-- ...      | `λ- | `λ- = {!!}
-- ...      | `λ- | x `$ x₁ & x₂ = {!!}
-- ...      | `λ- | `zero = {!!} -- impossible
